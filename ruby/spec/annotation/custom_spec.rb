  ...
  context "serialize an object using custom serialization" do
    describe "given a labeled attribute that serializes with custom annotation" do
      ...
      it "automatic serialization gives expected output" do
        ...
        xml_doc = doc.xml
        puts xml_doc
        expected_document = '<alumnoConEstadoCustom nombre="Matias" legajo="123456-7" telefono="1234567890"><situacion><regular>true</regular><pendientes>2<pendientes></situacion></alumnoConEstadoCustom>'
